...
The redux store holds ALL of the state for the application. Reducers are the place where the state is updated and actions tell the reducers how to update the state.

- [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?

Component state is stored locally within a component and has to be passed in as props. Application state is immutable and is modified by actions. it would be a good idea to use component state when we don't want state to be used by any other objects.

- [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

Thunk makse it so you can write action creators that return a function.

- [ ] What is your favorite state management system you've learned and this sprint? Please explain why!

Redux... While it is probably the hardest state management system it is the most versatile.
